...
VALUES ( '$icPatient', '$password', '$patientFirstName', '$patientLastName','$patientMaritialStatus', '$patientDOB', '$patientGender', '$patientAddress', '$patientPhone', '$patientEmail' ) ";
...
<html lang="en">
    <head>
        ...
        <title>Aman Dental Appointment System</title>
        <!-- Bootstrap -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <label>Address: &nbsp;&nbsp;</label>
                                        <br>
                                        <textarea  name="patientAddress" rows="5" cols="50" placeholder="Your Address"></textarea>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>This is the time slots available. Please <span class="label label-danger">login</span> to make an appointment. </p>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                ...
                <div class="container py-5">
                    ...
                    $result = mysqli_query($con, $query);
                    $check_treatment = mysqli_num_rows($result) > 0;
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                        ...
                        <div class="col-lg-4 mb-3">
                            <div class="card">
                            <h4 class="card-title" class="center"> <?php echo $row['treatName']; ?> </h4>
                            <img src='clerk/upload/<?php echo $row['treatImg']; ?>' width='200px' height='130px' alt='image'>
                                <div class="card-body">
                                <h5 class="card-title" style="font-weight: bold;"> RM <?php echo $row['treatPrice']; ?> </h5>
                                    <p class="card-text">
                                        <?php echo $row['treatDesc']; ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    {
                    echo "No record of treatment found";
                    }
                    ?>
